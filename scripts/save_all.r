...
go <- function(mld, name) {
  file <- paste0("../public/full/", name, ".rds")
...
datasets <- .w(gsub(".rda", "", "birds.rda cal500.rda emotions.rda flags.rda genbase.rda langlog.rda medical.rda ng20.rda slashdot.rda stackex_chess.rda"))
